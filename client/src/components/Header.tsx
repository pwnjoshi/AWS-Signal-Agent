...
export const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <header className="h-16 bg-white dark:bg-[#121216] border-b border-slate-200 dark:border-zinc-800 px-4 sm:px-6 flex items-center justify-between sticky top-0 z-30 text-slate-900 dark:text-zinc-100 font-sans transition-colors">
      ...
      {/* Search Input */}
      <div className="flex-1 max-w-md mx-2 sm:mx-4 relative font-sans">
      ...
      <div className="flex items-center gap-2.5 shrink-0 text-xs">
        ...
        <Link
          to="/"
          className="hidden md:inline-flex items-center gap-1.5 bg-slate-50 dark:bg-[#18181b] hover:bg-slate-100 dark:hover:bg-[#1f1f26] text-slate-600 dark:text-zinc-400 hover:text-slate-900 dark:hover:text-zinc-100 px-3 py-1.5 rounded-lg font-medium transition-all border border-slate-200 dark:border-zinc-800"
        ...
        <button
          ...
          className="flex items-center gap-1.5 bg-slate-50 dark:bg-[#18181b] hover:bg-slate-100 dark:hover:bg-[#1f1f26] border border-slate-200 dark:border-zinc-800 px-3 py-1.5 rounded-lg font-medium text-slate-700 dark:text-zinc-300 transition-all cursor-pointer"
        ...
        <button
          ...
          className="flex items-center gap-1.5 bg-blue-600 hover:bg-blue-700 text-white px-3.5 py-1.5 rounded-lg font-medium text-xs shadow-sm transition-all active:scale-98 disabled:opacity-50 cursor-pointer"
        >
          {isAgentRunning ? (
            <>
