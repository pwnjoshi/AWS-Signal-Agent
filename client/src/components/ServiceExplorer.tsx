  ...
  return (
    <div className="space-y-6 font-mono text-slate-900 dark:text-zinc-100 pb-12">
      ...
      <div className="bg-white dark:bg-[#121216] rounded-xl border border-slate-200 dark:border-zinc-800 p-4 sm:p-5 shadow-sm transition-colors">
        <h2 className="text-xs font-bold text-slate-600 dark:text-zinc-400 uppercase tracking-wider mb-3">
        ...
        <div className="space-y-5">
          <div className="bg-white dark:bg-[#121216] border border-slate-200 dark:border-zinc-800 rounded-xl p-5 sm:p-6 shadow-sm transition-colors">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              ...
              <div className="bg-slate-50 dark:bg-[#18181b] border border-slate-200 dark:border-zinc-800 p-3 rounded-lg text-center shrink-0">
                <span className="text-[10px] text-slate-500 dark:text-zinc-400 font-bold block uppercase tracking-wider">Avg Score</span>
                <span className="text-xl font-black text-blue-600 dark:text-blue-400">{activeService.avg_signal_score}/100</span>
              </div>
            </div>
          </div>
          ...
          <div>
            <h3 className="text-sm font-bold text-slate-900 dark:text-zinc-100 mb-3.5 flex items-center gap-2 uppercase tracking-wide">
