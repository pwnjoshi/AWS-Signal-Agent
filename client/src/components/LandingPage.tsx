...
export const LandingPage: React.FC<LandingPageProps> = ({ onGetStarted, onOpenAuthModal }) => {
  ...
  return (
    <div className="min-h-screen bg-background text-on-background selection:bg-primary/20 selection:text-primary relative font-sans overflow-x-hidden transition-colors">
      ...
      {/* Interactive Particle Canvas & Dynamic Grid */}
      <div className="fixed inset-0 pointer-events-none -z-10">
        <div className="absolute inset-0 site-main-grid opacity-30" />
        <div className="laser-grid-line-h" />
        <div className="laser-grid-line-v" />
      ...
      <section id="home" className="relative pt-28 sm:pt-36 pb-16 sm:pb-24 min-h-[88vh] flex items-center justify-center">
        
        {/* Floating AWS Badges on Desktop */}
        <div className="hidden lg:block absolute left-8 top-1/3 -translate-y-1/2 pointer-events-none">
          <div className="w-14 h-14 rounded-2xl bg-surface/90 border border-outline shadow-lg backdrop-blur-md flex items-center justify-center p-2.5 animate-float">
          ...
          <div className="w-12 h-12 rounded-2xl bg-surface/90 border border-outline shadow-lg backdrop-blur-md flex items-center justify-center p-2 mt-8 animate-float" style={{ animationDelay: '1.2s' }}>
        ...
        <div className="hidden lg:block absolute right-8 top-1/3 -translate-y-1/2 pointer-events-none">
          <div className="w-14 h-14 rounded-2xl bg-surface/90 border border-outline shadow-lg backdrop-blur-md flex items-center justify-center p-2.5 animate-float" style={{ animationDelay: '0.6s' }}>
            <span className="text-xs font-mono font-black text-[#fe9800] dark:text-secondary">Lambda</span>
          </div>
          <div className="w-12 h-12 rounded-2xl bg-surface/90 border border-outline shadow-lg backdrop-blur-md flex items-center justify-center p-2 mt-8 animate-float" style={{ animationDelay: '1.8s' }}>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 text-center space-y-8 relative z-10">
          ...
          {/* Active Builder Status Pill */}
          <div className="inline-flex items-center gap-3 px-4 py-1.5 rounded-full bg-surface-low/90 border border-outline shadow-sm backdrop-blur-xl font-mono text-xs text-on-surface-variant hover:border-primary/40 transition-all">
            <div className="flex -space-x-1.5">
              <span className="w-5 h-5 rounded-full bg-primary/20 border border-primary text-[9px] font-bold flex items-center justify-center text-primary">GEU</span>
              <span className="w-5 h-5 rounded-full bg-[#fe9800]/20 border border-[#fe9800] text-[9px] font-bold flex items-center justify-center text-[#fe9800]">AWS</span>
            </div>
            <span className="font-bold text-on-background">800+ Active Builders</span>
          ...
          <div className="space-y-4">
            <h1 className="font-black font-display leading-[1.08] tracking-tight uppercase text-3xl sm:text-5xl md:text-6xl text-on-background">
              WHERE CLOUD BUILDERS <br />
              <span className="inline-flex items-center px-4 py-1 rounded-full bg-primary/15 border border-primary/30 text-primary text-[0.85em] font-mono uppercase tracking-wider font-extrabold align-middle my-1">
                STAY INFORMED
              </span> <br />
            ...
            <p className="max-w-2xl mx-auto text-xs sm:text-base text-on-surface-variant leading-relaxed font-sans font-normal">
          ...
          <div className="flex flex-wrap items-center justify-center gap-3.5 pt-2 font-mono">
            <Link
              to="/dashboard"
              className="px-6 py-3 btn-geu-primary text-white rounded-xl text-xs font-bold uppercase tracking-wider shadow-purple-glow active:scale-95 transition-all flex items-center gap-2"
            >
            ...
            <button
              ...
              className={`px-5 py-3 rounded-xl text-xs font-bold uppercase tracking-wider border transition-all flex items-center gap-2 cursor-pointer ${
                isSpeaking
                  ? 'bg-amber-500 text-white animate-pulse border-amber-400'
                  : 'bg-surface-low border-outline hover:bg-surface-container text-on-background'
              }`}
            >
              {isSpeaking ? (
                <>
          ...
          {isSpeaking && (
            <div className="flex items-center justify-center gap-1.5 pt-2">
              <span className="audio-bar" style={{ height: '14px' }} />
              <span className="audio-bar" style={{ height: '22px' }} />
              <span className="audio-bar" style={{ height: '32px' }} />
              <span className="audio-bar" style={{ height: '18px' }} />
              <span className="audio-bar" style={{ height: '26px' }} />
              <span className="audio-bar" style={{ height: '12px' }} />
              <span className="text-[11px] font-mono text-primary font-bold ml-2">Dori Voice Synthesizer Streaming</span>
            </div>
          )}
      ...
      <section className="border-y border-outline bg-surface-low/80 backdrop-blur-md py-4 font-mono text-xs">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 flex flex-wrap items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            <span className="w-2.5 h-2.5 rounded-full bg-[#00d294] animate-ping" />
          ...
          <div className="flex flex-wrap items-center gap-6 text-[11px] text-on-surface-variant">
            ...
            <span>⏱ Interval: <strong className="text-[#fe9800] dark:text-secondary font-bold">EventBridge Cron</strong></span>
          </div>
        </div>
      </section>

      {/* ── Section 3: Bento Grid Intelligence (From GEU Reference Design) ── */}
      <section id="intelligence" className="py-20 sm:py-28 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 space-y-12">
          ...
          <div className="text-center space-y-3">
            ...
            <h2 className="text-2xl sm:text-4xl md:text-5xl font-black font-display text-on-background tracking-tight uppercase">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
            ...
            <div className="md:col-span-8 p-8 rounded-3xl premium-card relative overflow-hidden flex flex-col justify-between min-h-[340px]">
              <div className="absolute top-0 right-0 w-80 h-80 bg-primary/10 rounded-full blur-3xl pointer-events-none" />
              
              <div>
                <span className="text-[10px] font-mono font-bold text-primary uppercase tracking-widest block mb-2">Signature Capability</span>
                <h3 className="text-xl md:text-2xl font-bold text-on-background uppercase mb-3 font-display">
                  "While You Were Away" Executive Synthesis
                </h3>
                <p className="text-on-surface-variant text-xs sm:text-sm leading-relaxed max-w-2xl font-light">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 pt-6 border-t border-outline font-mono">
                <div className="p-3 bg-surface-low border border-outline rounded-xl">
                  <span className="text-[9px] text-on-surface-variant uppercase block font-bold">Announcements</span>
                  <span className="text-lg font-black text-on-background">03</span>
                </div>
                <div className="p-3 bg-surface-low border border-outline rounded-xl">
                  <span className="text-[9px] text-on-surface-variant uppercase block font-bold">Discussions</span>
                  <span className="text-lg font-black text-on-background">07</span>
                </div>
                <div className="p-3 bg-surface-low border border-outline rounded-xl">
                  <span className="text-[9px] text-on-surface-variant uppercase block font-bold">Emerging</span>
                  <span className="text-lg font-black text-[#00d294]">02</span>
                </div>
                <div className="p-3 bg-surface-low border border-red-500/30 rounded-xl">
            ...
            <div className="md:col-span-4 p-8 rounded-3xl premium-card flex flex-col justify-between font-mono">
              <div className="space-y-2">
                <span className="text-[10px] font-mono font-bold text-primary uppercase tracking-widest block">Bedrock Algorithm</span>
                <h4 className="text-lg font-bold text-on-background uppercase font-display">5-Pillar Score</h4>
                <p className="text-on-surface-variant text-xs">Each raw item is ranked dynamically across weighted parameters.</p>
              </div>

              <div className="space-y-2.5 pt-4 text-xs">
                <div className="flex justify-between items-center border-b border-outline pb-1.5">
            ...
            <div id="dori" className="md:col-span-12 p-8 rounded-3xl premium-card relative overflow-hidden flex flex-col space-y-6">
              ...
              <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                <div className="space-y-2 max-w-2xl">
                  ...
                  <h3 className="text-xl md:text-2xl font-bold text-on-background uppercase font-display">
                    Meet Dori: Your Autonomous Cloud Specialist
                  </h3>
                  <p className="text-on-surface-variant text-xs sm:text-sm leading-relaxed font-light">
                    Dori isn't a chatbot you have to query all day. She runs autonomously in the background, learns your Builder ID stack preferences, and only surfaces intelligence that directly impacts your systems.
                  </p>
                </div>
              ...
              {/* Dori Simulator Box */}
              <div className="bg-surface-low border border-outline rounded-2xl p-6 font-mono space-y-4">
                <div className="flex items-start gap-3 text-xs sm:text-sm text-primary font-bold">
                  <Terminal className="w-4 h-4 shrink-0 mt-0.5" />
                  <span>{DORI_PROMPTS[activePromptIdx].q}</span>
                </div>
                <div className="pl-7 text-xs sm:text-sm text-on-background font-sans leading-relaxed">
                  {DORI_PROMPTS[activePromptIdx].a}
                </div>
                <div className="pl-7 pt-2 flex items-center gap-2 text-[10px] text-on-surface-variant">
      ...
      <section id="how-it-works" className="py-20 sm:py-28 border-t border-outline bg-surface-low/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          <div className="text-center space-y-3 font-mono">
            ...
            <h2 className="text-2xl sm:text-4xl font-black font-display text-on-background tracking-tight uppercase">
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-4 font-mono text-xs">
            {[
              ...
              <div key={s.step} className="bg-surface border border-outline rounded-2xl p-5 space-y-2 hover:border-primary/40 transition-all shadow-sm">
                <span className="text-xs font-black text-primary">{s.step}.</span>
                <h4 className="text-sm font-bold text-on-background uppercase">{s.title}</h4>
      ...
      {/* ── Section 5: Leadership & Community Roster ── */}
      <section className="py-20 sm:py-28 border-t border-outline">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-2 gap-4 sm:gap-6 max-w-3xl mx-auto">
            {/* Faculty Lead */}
            <div className="group relative rounded-2xl overflow-hidden border border-outline bg-surface aspect-[3/4] transition-all hover:border-primary/40 shadow-md">
              <img 
              ...
              <div className="absolute bottom-0 left-0 w-full p-4 flex flex-col justify-end font-mono">
                <span className="text-[9px] font-bold text-primary uppercase tracking-wider bg-black/60 px-2 py-0.5 rounded w-fit mb-1">
                  Faculty Lead
                </span>
      ...
      <footer className="relative font-mono bg-surface-low border-t border-outline overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-12">
          
          <div className="py-8 border-b border-outline flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
            <div>
              <p className="text-xs font-bold text-primary uppercase tracking-wider mb-1">
                AWS Student Builder Group • GEU Chapter
              </p>
              <h2 className="text-2xl sm:text-4xl font-black text-on-background uppercase tracking-tight">
            ...
            <Link
              to="/dashboard"
              className="px-6 py-3.5 btn-geu-primary text-white rounded-xl text-xs font-bold uppercase tracking-wider shadow-purple-glow flex items-center gap-2"
            >
              <span>Launch Command Hub</span>
